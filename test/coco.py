...
def kp_detection(db, nnet, result_dir, debug=False, decode_func=kp_decode):
    ...
    for db_ind in tqdm(db_inds, ncols=80, desc="locating kps"):
        ...
        for scale in scales:
            ...
            # print(new_height, inp_height, new_width, inp_width)
            # print('next')
            ...
            # print('out_height = {}, out_width = {}'.format(out_height, out_width))
            height_ratio = out_height / inp_height
            width_ratio  = out_width  / inp_width

            resized_image = cv2.resize(image, (new_width, new_height))
            resized_image, border, offset = crop_image(resized_image, new_center, [inp_height, inp_width])
            # plt.imsave('testi.png', image)
            # plt.imsave('testr.png', resized_image)
            ...
            # for_debug = images[0]
            # print(images.shape)
            # print(type(for_debug))
            # plt.imsave('test.png', [for_debug[1], for_debug[2], for_debug[0]])
            borders[0] = border
            ...
            # plt.imsave('testi.png', images[0].transpose(1,2,0))
            # plt.imsave('testr.png', img)
